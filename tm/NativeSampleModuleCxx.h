...
private:
 ...
 public:
  ...
  facebook::react::AsyncPromise2<std::string> startPromise7(jsi::Runtime &rt);
  ...
  facebook::jsi::Function getInfoCallback(jsi::Runtime &rt, AsyncCallback2<std::string> onResponse, AsyncCallback2<std::string> onError);
